...
2) Скачав zip-архив репозитория и распаковав его, запустить проект в PyCharm (предварительно установив все нужные библиотеке + tzdata)
3) Склонировав репозиторий, запустить проект в PyCharm (предварительно установив все нужные библиотеке + tzdata)
