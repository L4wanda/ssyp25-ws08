...
Примечание для п. 2 и 3: список используемых библиотек можно посмотреть в requirements.txt, а также использовать его для автоматической установки библиотек;
для запуска можно использовать и другую IDE (главное, чтобы всё три файла gui_code.py, skydome_cuda.py и application.ui из репозитория были использованы)
# Состав мастерской
## Ученики
...
## Руководители
* Ванда Владислав Сергеевич (мастер)
* Чемоданов Егор Михайлович (подмастерье)
