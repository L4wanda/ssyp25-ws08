...
def render_kernel(
    ...
    red = _single_scatter(BETA_R, BETA_M, use_mie, 0.0, EARTH_RADIUS, 0.0,
                          v0, v1, v2, l0, l1, l2, scale_height_mie if use_mie else scale_height_rayleigh, 0)
    green = _single_scatter(BETA_R, BETA_M, use_mie, 0.0, EARTH_RADIUS, 0.0,
                            v0, v1, v2, l0, l1, l2, scale_height_mie if use_mie else scale_height_rayleigh, 1)
    blue = _single_scatter(BETA_R, BETA_M, use_mie, 0.0, EARTH_RADIUS, 0.0,
                           v0, v1, v2, l0, l1, l2, scale_height_mie if use_mie else scale_height_rayleigh, 2)
...
class SkydomeRenderer:
    ...
    def __init__(self, use_mie: bool, latitude, longitude, width, height, scale_height_rayleigh, scale_height_mie):
        self.width = width
        self.height = height
        ...
        self.scale_height_mie = scale_height_mie
    ...
    def render(self, hour_utc: int) -> np.ndarray:
        ...
        render_kernel[self.blocks, self.threads](self.d_img, theta0, phi0, self.use_mie, self.width, self.height,
                                                 self.scale_height_rayleigh, self.scale_height_mie)
